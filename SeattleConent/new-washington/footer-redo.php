...
(function(a){a(function(){a("ul.tabs").delegate("li:not(.current)","click",function(){a(this).addClass("current").siblings().removeClass("current").parents("div.selection").find("div.panel").hide().eq(a(this).index()).show();return false})})})(jQuery);
$(document).ready(function(){$('.cats a .count').hide();
$('.cats a').hover(function() {$(this).find('.count').fadeToggle();});
$("input[type=text]").each(function(){var a=this.value;$(this).focus(function(){if(this.value==a){this.value=""}});$(this).blur(function(){if(this.value==""){this.value=a}})})});
//</script>
            </div><!-- .container -->
        </section>
        <!-- CONTENT ENDS -->
        ...
        <footer>
            <div class="container">
                                        ...
                                        <p style="color: #fff;">RECENT</p>
                                          ...
                                          <?php
                                                            ...
                                                            //echo esc_html(get_post_meta($post->ID, 'settledby', true));
                                                                the_title();
                                                            echo '</span><a href="' . the_permalink(); . '" ';
                                                            echo '<p class="arvo"> ';
                ...
                <div class="row-fluid copyright_wrap">
                    ...
                    <div class="span4">
                            <!--PM  Insert data:breadcrumbs:others schema *optional -->
                        <section>  <?php if (function_exists('HAG_Breadcrumbs')) { HAG_Breadcrumbs(); } ?></section>
