            ...
            //      wp_enqueue_script('jquery.responsivetext', get_stylesheet_directory_uri() . '/js/jquery.responsivetext.js', array( 'jquery' ), false, false, true);
               ...
               if (is_page_template('page-small-banner.php') ) {
                 ...
                 if (is_page_template('front-page.php') ) {
                    wp_enqueue_script('jquery.rwdImageMaps.js', get_stylesheet_directory_uri() . '/js/jquery.rwdImageMaps.js', array( 'jquery' ), false, false, true);
                    wp_enqueue_script('jquery.rwdImageMaps.min.js', get_stylesheet_directory_uri() . '/js/jquery.rwdImageMaps.min.js', array( 'jquery' ), false, false, true);
...
// CUSTOM USER PROFILE FIELDS
   function my_custom_userfields( $contactmethods ) {
    // ADD CONTACT CUSTOM FIELDS
    $contactmethods['google_pm_author_url']     = 'Google Plus Author Profile Link <br> ( phillip added )';
    $contactmethods['google_pm_author_name']     = 'Google Plus Author Profile Name  <br> ( phillip added )';
