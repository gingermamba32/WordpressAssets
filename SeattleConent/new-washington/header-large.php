...
<script type="text/javascript">
  (function() {
    ...
    po.src = "https://apis.google.com/js/plusone.js?publisherid=102881086543400845421";
                        ...
                        <div class="span12">
                            ...
                            <?php if (!empty($phone) || !empty($email)) { ?>
                                <div class="header_contact rounded">
                                         <?php if (!empty($phone)) { ?>
                                        <div onClick="ga('send', 'event', 'click', 'headerPhone', true);" class="phone">
                                            <img src="<?php echo get_template_directory_uri(); ?>/style/images/icon-phone.png" alt="phone icon" />
                                           <a  onclick="ga('send', 'event', 'headerPhone', 'Click', window.location.pathname, true);"  style="font-size: 1.6em;" href="tel:<?php echo stripslashes($phone); ?>">
                                    ...
                                    <?php } ?>
                   <!--                  <?php if (!empty($email)) { ?>
                                        <div class="email"><img src="<?php echo get_template_directory_uri(); ?>/style/images/icon-letter.png" alt="letter icon" /><span><a onClick="ga('send', 'event', 'click', 'MailTo:', true);" href="mailto:<?php echo $email; ?>"><?php echo stripslashes($email); ?></a></span></div>
                                    <?php } ?> -->
<!--                                     <div class="jivo-btn jivo-online-btn jivo-btn-light jivo-btn-gradient" onclick="jivo_api.open();" style="font-family: Arial, Arial;font-size: 13px;background-color: #DB7900;border-color: #844800;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;height: 39px;line-height: 39px;padding: 0 19px 0 19px;font-weight: bold;text-shadow: 0 1px #844800"><div class="jivo-btn-icon" style="background-image: url(//static.jivosite.com/button/chat_light.png);"></div>Chat with us, we are online!</div><div class="jivo-btn jivo-offline-btn jivo-btn-light jivo-btn-gradient" onclick="jivo_api.open();" style="font-family: Arial, Arial;font-size: 13px;background-color: #DB7900;border-color: #844800;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;height: 39px;line-height: 39px;padding: 0 19px 0 19px;display: none;font-weight: bold;text-shadow: 0 1px #844800"><div class="jivo-btn-icon" style="background-image: url(//static.jivosite.com/button/mail_light.png);"></div>Send us a message</div>
 -->
...
<div class="full-header" > <?php   if ( has_post_thumbnail() ) {      the_post_thumbnail();  }// pm added banner image for pages ?>
            </div>
            <div class="row-fluid">
