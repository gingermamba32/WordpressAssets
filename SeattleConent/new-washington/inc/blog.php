...
<section>
    <div class="container">
		...
		the_post_thumbnail( 'blog-page', array( 'itemprop' => 'image' ) );
		// itemprop="primaryImageOfPage"// pm added banner image for pages ?>
        </div>
...
-->
        ...
        <div class="row-fluid">
            ...
            <div id="content" class="<?php if($sidebar_postition == 'right'){echo 'span8 pull-left';}elseif($sidebar_postition == 'left'){echo 'span8 pull-right';}elseif($sidebar_postition == 'fullwidth'){echo 'span12';}?>">
                ...
                <div class="blog_post blog_listing" <?php echo $padding; ?>>
                    <?php
...
<!--  <div id="breadcrumbs" style="width:940 !important;margin:0 auto;">
