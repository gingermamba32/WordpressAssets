...
$meta_boxes = array(
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                'name' => __('Google Plus Account', tk_theme_name()),
                'desc' => 'Place a link to your Personal Google Plus account associated with the company googleplus  (i.e. http://www.GooglePlus.com/me)',
                'id' => $prefix . 'googepluspm',
                'type' => 'text',
                'std' => ''
            ),
