...
function post_types_adding() {
  ...
  flush_rewrite_rules();
        ...
        /**************************************************************/
        /************GALLERY- WORK INJURY POST TYPE PM********************************/
        /*************************************************************/
  ...
  $labels = array(
    ...
    'parent_item_colon' => '',
    'menu_name' => __('Injury', tk_theme_name),
  ...
  $labels = array(
    ...
    'parent_item_colon' => '',
    'menu_name' => __('Attorneys', tk_theme_name),
  ...
  $args = array(
    ...
    'supports' => array('title', 'editor', 'thumbnail', 'excerpt', 'author', 'custom-post-format' ),
);
...
//     'add_or_remove_items'        => __( 'Add or remove FAQ Types' ),
//     'choose_from_most_used'      => __( 'Choose from the most used FAQ Types' ),
//     'separate_items_with_commas' => __( 'Separate FAQ Types with commas' ),
...
//     'rewrite'            => true,
// );
// register_taxonomy( 'faqtype', $cpts, $args );
