...
//$image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'full', array( 'itemprop' => 'image' );
...
<section>
    ...
    <div class="container" id="Person"  itemscope="itemScope" itemtype="http://schema.org/Person">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <?php if ($page_headline !== "") { ?>
                        <h2 class="page_description" itemprop="headline"><?php echo $page_headline ?></h2>
                    <?php } ?>
                </div>
            </div>
            <div class="row-fluid">
