            ...
            <div class="row-fluid">
                <div class="span12">
                    <?php if (is_front_page()) { ?>
                        <h1 itemscope="" itemtype="http://schema.org/WebPageElement/Heading" class="hero_heading"><?php echo $page_headline; ?></h1>
                    <?php } else { ?>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <img src="<?php echo get_template_directory_uri(); ?>/style/images/separator.png" alt="separator" />
                           <br />     <br />
                             <?php  if ( has_post_thumbnail() ) the_post_thumbnail( 'lower-blog-header', array( 'itemprop' => 'image' ) ); // pm added banner image for pages ?>
                </div>
            </div>
            <br>
