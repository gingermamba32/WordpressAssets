                ...
                <div class="span12 ca-item ca-item<?php echo $post->ID; ?> rounded">
                    <a href="<?php the_permalink(); ?>">
                        <?php if(!empty($featured_service_img)) { ?>
                            <span class="ca-icon">
                                <img itemprop="image"      class="ca-main" src="<?php tk_get_thumb(86, 86, $featured_service_img ); ?>" alt="<?php the_title(); ?>"  title="<?php the_title(); ?>" />
                                <div class="clear"></div>
                            </span>
                        <?php } ?>
                ...
                <div class="home-content-ad left">
                    <?php if(!empty($custom_banner)) {
                        ...
                        <a href="<?php site_url(); ?>?banner_id=<?php echo $ad_post; ?>">
                            <img itemprop="image"     src="<?php echo $image_src[0]; ?>" title="<?php the_title($ad_post)?>" alt="<?php the_title($ad_post)?>"/>
                        </a>
                    <?php } ?>
                </div>
            </div><!-- /span12 -->
