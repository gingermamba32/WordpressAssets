...
?>
<div id="wrappertwopage" class="custom-background-color" style="background:#baba95;">
<div class="container">
        <section>
            <div class="container">
                <br /><br />
           <span class="2col-home page_description arvo" style="font-weight:normal;"><center>What Can A Personal Injury &amp; Accident Attorney Do For You?</center></span><br />
           <span class="nunito midtext" style="color: #004865;"><center>Here at The Advocates, your lawyer will provide "YOU" with active and aggressive representation, immediate response and direct communication with your lawyer and we will see your case through to the end. We're not just lawyers: <strong>We Are Your Advocates.</strong></center></span>
            </div>
        </section>
<br />
                ...
                <style type="text/css">
                    ...
                    <a href="<?php the_permalink(); ?>">
                        ...
                        <div class="ca-content">
                            <h1class="ca-main"><?php the_title(); ?></h1>
...
<?php } elseif ($get_post_type == 'news') { ?>
        <div class="span6 news">
            ...
            <?php if(!empty($latest_news_title_left)){ ?>
                <h3class="slider-titles"><?php echo $latest_news_title_left; ?></h3>
            <?php } ?>
            <div class="row-fluid">
                <div class="span12 home-page-border"></div>
            </div>
