                ...
                <div id="content" class="<?php if($sidebar_postition == 'right'){echo 'span8 pull-left';}elseif($sidebar_postition == 'left'){echo 'span8 pull-right';}elseif($sidebar_postition == 'fullwidth'){echo 'span12';}?>">
                    ...
                    <div>
                        ...
                        ?>
                         ...
                         <div class="service_wrap service-<?php echo $post->ID; ?> rounded" style="padding: 30px; background: #<?php echo $tk_background_color;?>; color: #<?php echo $tk_headline_color; ?>; margin-bottom: 40px;">
                            <?php if ($featured_service_img !== '') { ?>
                                <img class="service_small_featured" src="<?php echo $featured_service_img; ?>" width="86" />
                            <?php } ?>
                            <h2 itemprop="articleSection" <?php if ($featured_service_img == '') { echo 'style="margin-top: 0;"'; } ?>>
                            	<a href="<?php the_permalink(); ?>" style="color: #<?php echo $tk_headline_color ; ?>;"><?php the_title(); ?></a></h2>
                            <div class="clear"></div>
                            <p  itemprop="about" style="color: #<?php echo $tk_text_color; ?>;"><?php the_excerpt_length(109); ?></p>
