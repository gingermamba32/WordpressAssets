...
<section>
  ...
  <div itemscope itemtype="http://schema.org/Attorney">
                    <meta itemprop="name" content=" Law Offices of Driggs, Bills & Day PC" />

               <meta itemprop="telephone" content="+18013260809" />
            <meta class="email" itemprop="email" content="Contact@UtahAdvocates.com" />
...
<div itemscope itemtype="http://schema.org/Person">
                    <div  itemprop="photo" class="span8 team_member_info <?php if(empty($featured_right)) { echo 'pull-right'; }else{ echo 'pull-left'; }?>">
                        <div class="our-team-page-one-title left">
                            <a id="<?php echo $post->post_title; ?>"></a>
                        </div><!--/our-team-page-one-title-->
                 ...
                 <span itemprop="description" >       <?php  the_content(); ?></span>
                    ...
                    <?php if(empty($featured_right)) { ?>
                        <div class="span4 team_member pull-left" style="margin-left:0;">
                            ...
                            <span  itemprop="nickname"  class="member_title"><?php if(!empty($tk_member_title)){ echo $tk_member_title; } ?></span>
