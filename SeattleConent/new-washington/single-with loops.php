...
<section>
 ...
 <ul id="event-list" >
    <?php
//     $loop = new WP_Query( array( 'post_type' => 'payout',  'posts_per_page' => 5 ) );   while ( $loop->have_posts() ) : $loop->the_post();
// if ( get_post_meta( $post->ID, 'settledby', true ) != '' ) {
//     the_title( '<li><div class="single_event"><div style="width:200px;"  class="left-loc event_title event-title  ' . the_title_attribute( 'echo=0' ) . '"><a href="' . get_permalink() . '" title="' . the_title_attribute( 'echo=0' ) . '" rel="Event">' );
//     echo "<div class=\"right-loc event_date\"  style=\"float:right\" >";

//     echo get_post_meta( $post->ID, 'settledby', true );
//     echo "</div></a></div></div></li>";
//     wp_reset_postdata();  }
?>
...
echo '<li><span class="arvo" style=""> Settledby: <br />Salt Lake Attorney ';
echo esc_html(get_post_meta($post->ID, 'settledby', true));
echo '</span><span class="arvo" style=""> ';
    the_title();
    echo '</span></li>';
    echo '<span style="text-align:center;" class="entry-content">';
    the_content();
    echo '</span>';
endwhile
 ?>
...
<span class="arvo" style="font-weight: 500;color:#fff;background:#6d6a4c; font-size: 2em;line-height: 2em;padding:10px 40px;">Salt Lake Attorney <?php echo esc_html(get_post_meta($post->ID, 'settledby', true));?> </span><br />
<span class="ptsans" style="color:#004865; font-size: 2em;line-height: 2em;">Has Settled Another Case For an Estimated Settlement of <?php echo esc_html(get_post_meta($post->ID, 'payout', true));?></span>
<br /><br />
...
<span itemscope itemtype="http://schema.org/Review">
    <span itemprop="itemReviewed" itemscope itemtype="http://schema.org/Attorney">
        <a itemprop="url" href="<?php the_permalink(); ?> " class="visuallyhidden">
...
echo '<div style="width:450px;" class="accordion" id="accordion' .$cntr .'"><div class="accordion-group"> <div class="accordion-heading">    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion' .$cntr .'" href="#8208' .$cntr .'">Settledby: <br />Salt Lake Attorney  ';
echo esc_html(get_post_meta($post->ID, 'settledby', true));

    echo '</a></div>';
    the_field('ratingValue');
echo '<div id="8208' .$cntr.'" class="accordion-body  in collapse" style="height: auto;">';
...
<div class="accordion" id="accordion2"><div class="accordion-group">
    <div class="accordion-heading">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion2" href="#8208">Title</a>
        </div>
        <div id="8208" class="accordion-body  in collapse" style="height: auto;">
