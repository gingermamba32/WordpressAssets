        ...
        <div class="row-fluid">
            ...
            <div id="content" class="<?php if($sidebar_postition == 'right'){echo 'span8 pull-left';}elseif($sidebar_postition == 'left'){echo 'span8 pull-right';}elseif($sidebar_postition == 'fullwidth'){echo 'span12';}?>">
                ...
                <article class="blog_post" <?php echo $padding; ?>>
                    ...
                    <!-- Post Content -->
                    <br>
<span  itemscope="itemscope" itemtype="http://schema.org/Person" class="arvo" style="font-weight: 500;color:#fff;background:#6d6a4c; font-size: 2em;line-height: 2em;padding:10px 40px;"><span itemprop="name">Salt Lake Attorney <?php echo esc_html(get_post_meta($post->ID, 'settledby', true));?> </span></span><br />
...
<br /><br />
             ...
             <div style="background:#fff; padding:50px;">     <?php echo esc_html(get_post_meta($post->ID, 'description', true));?>  <?php // the_content(); ?></div>
