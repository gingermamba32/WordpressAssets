...
?><h3 itemprop=" relatedLink" ><?php echo (function_exists("icl_t") ? icl_t("Yet Another Related Posts Plugin", "related posts header", "Related Posts") : "Related Posts") ?></h3>
<?php if (have_posts()):?>
<ol>
	<?php while (have_posts()) : the_post(); ?>
	<li><a itemprop=" relatedLink" href="<?php the_permalink() ?>" rel="bookmark"><span itemprop="name" ><?php the_title(); ?></span></a></li>
	<?php endwhile; ?>
</ol>
<?php else: ?>
